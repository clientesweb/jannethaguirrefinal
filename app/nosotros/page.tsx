...
import { Users, Building, Star, ArrowLeft, Award, Globe, Phone, Mail } from "lucide-react"
              ...
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
                ...
                <div className="order-1 lg:order-2">
                  <p className="font-poppins text-gray-600 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
                    Janneth Aguirre es una reconocida profesional del sector inmobiliario en Ecuador, con más de{" "}
                    <strong>14 años de experiencia</strong> y una trayectoria consolidada en la comercialización de
                    proyectos en planos, inversiones de alta rentabilidad y gestión de alquileres corporativos.
                  </p>
                  <p className="font-poppins text-gray-600 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-base sm:text-lg lg:text-xl font-poppins text-white mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
                Con más de 14 años de experiencia y reconocimiento internacional, estoy aquí para ayudarte a encontrar
